...
/** Reflective bridge to Slimefun Legacy's optional Addon Doctor API. */
public final class LegacyDoctorBridge {
    ...
    public static void register(BetterChests plugin) {
        ...
        try {
            ...
            plugin.getLogger().info("Registered BetterChests with Slimefun Legacy Addon Doctor.");
        } catch (ClassNotFoundException ignored) {
            // Original/United/Gugu builds do not necessarily expose the optional Legacy API.
        } catch (ReflectiveOperationException | RuntimeException exception) {
            plugin.getLogger().log(Level.WARNING, "Could not register the optional Slimefun Doctor bridge.", exception);
        }
    }

    public static void unregister(BetterChests plugin) {
    ...
    private static Object invokeDoctor(
            ...
            Method method,
            Object[] arguments,
            Constructor<?> reportConstructor) throws ReflectiveOperationException {
