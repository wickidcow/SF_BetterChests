...
public final class LegacyDoctorBridge {
    ...
    public static void register(BetterChests plugin) {
        ...
        try {
            ...
            // Other Slimefun implementations do not necessarily expose the optional Legacy Doctor API.
    ...
    private static void registerRaw(ServicesManager services, Class service, Object provider, BetterChests plugin) {
